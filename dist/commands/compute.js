...
var compute_1 = __importDefault(require("@spheron/compute"));
var chalk = require("chalk");
var utils_1 = require("../utils");
var spinner_1 = __importDefault(require("../outputs/spinner"));
function compute() {
  return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var spinner, jwtToken, client, regions, instance, organization, cluster;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          _context.next = 11;
          return client.computeMachine.getRegions();
        case 11:
          regions = _context.sent;
          console.log(regions);
          _context.next = 15;
          return client.instance.get("64b37be14a65ee00121d83b1");
        case 15:
        ...
        case 19:
          ...
          _context.next = 23;
          return client.cluster.get("64b37be14a65ee00121d83b1");
        case 23:
          cluster = _context.sent;
          console.log(cluster);
