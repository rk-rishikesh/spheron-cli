...
function createOrganization(name, username, type) {
  return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var spinner, jwtToken, appType, organization;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          ...
          console.log("For creating new organisation, you need to login to Spheron first");
          return _context.abrupt("return");
        case 14:
          appType = type == core_1.AppTypeEnum.WEB_APP ? core_1.AppTypeEnum.WEB_APP : core_1.AppTypeEnum.COMPUTE;
          _context.next = 17;
          return spheron_api_1["default"].createOrganization(username, name, appType);
        case 17:
          organization = _context.sent;
          _context.next = 20;
          return (0, utils_1.writeToJsonFile)("organization", organization._id, configuration_1["default"].configFilePath);
        case 20:
          spinner.success("Organization ".concat(name, " is created"));
          _context.next = 27;
          break;
        case 23:
          _context.prev = 23;
